<template>
  <div class="space-y-6">
    <!-- Simplified Header -->
    <div class="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-lg text-white p-4">
      <h1 class="text-xl font-bold">Club Management Center</h1>
      <p class="text-blue-100">Review, approve, and manage cricket club registration applications</p>
    </div>
