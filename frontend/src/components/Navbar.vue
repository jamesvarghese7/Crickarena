      ...
      <div class="hidden md:flex items-center gap-3">
        ...
        <ul class="flex items-center gap-1 text-sm font-medium">
          ...
          <template v-if="auth.user">
            ...
            <li v-if="isPlayer">
              <RouterLink :to="'/player/dashboard'" v-slot="{ href }">
                <a :href="href" :class="navLinkClass('/player/dashboard')">Player Dashboard</a>
              </RouterLink>
            </li>
            <li v-if="isCoach">
              <RouterLink :to="'/coach/dashboard'" v-slot="{ href }">
                <a :href="href" :class="navLinkClass('/coach/dashboard')">Coach Dashboard</a>
              </RouterLink>
            </li>
          ...
          <transition name="fade">
            ...
            >
              ...
              <ul class="py-1 text-sm">
                ...
                <li v-if="isPlayer">
                  <RouterLink to="/player/dashboard" class="menuItem emerald">Player Dashboard</RouterLink>
                </li>
                <li v-if="isCoach">
                  <RouterLink to="/coach/dashboard" class="menuItem emerald">Coach Dashboard</RouterLink>
                </li>
                <li v-if="isAdmin">
        ...
        <div class="px-4 py-3">
          ...
          <ul class="space-y-1 text-sm font-medium">
            ...
            <template v-if="auth.user">
              ...
              <li v-if="isPlayer"><RouterLink @click="openMobile=false" to="/player/dashboard" class="mobileLink">Player Dashboard</RouterLink></li>
              <li v-if="isCoach"><RouterLink @click="openMobile=false" to="/coach/dashboard" class="mobileLink">Coach Dashboard</RouterLink></li>
