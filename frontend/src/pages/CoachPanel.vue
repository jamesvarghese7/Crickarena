      ...
      <aside :class="['bg-white/80 backdrop-blur-xl border-r border-white/20 w-80 shrink-0 flex flex-col shadow-2xl shadow-blue-500/10 fixed h-screen z-10', sidebarOpen ? 'flex' : 'hidden md:flex']">
        ...
        <div class="h-20 flex items-center px-6 border-b border-slate-200/50 bg-gradient-to-r from-blue-600 to-indigo-600">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <div class="text-sm text-blue-100 font-medium">Coach Portal</div>
            </div>
          </div>
        </div>
          ...
          <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-4 border border-blue-100">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1 min-w-0">
                <div class="font-bold text-slate-900 truncate text-lg">{{ coachData?.fullName || 'Coach' }}</div>
                <div class="text-sm text-slate-600 truncate" v-if="coachData?.currentClub">
                  {{ coachData.currentClub.clubName || coachData.currentClub.name }}
                </div>
                <div class="text-sm text-slate-600 truncate" v-else>
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          >
            ...
            <span class="nav-text">Goal Setting</span>
            <div class="nav-indicator"></div>
          </RouterLink>
          ...
          <div class="bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl p-4 border border-slate-200">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="text-xs text-slate-600">Cricket Coach</div>
              </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-slate-600">
                ...
                <span v-if="coachData?.address?.city && coachData?.address?.district" class="text-slate-400"> • {{ coachData.address.city }}, {{ coachData.address.district }}</span>
              </p>
            </div>
          </div>
...
const getPageTitle = () => {
  const titles = {
    ...
    'coach-panel-feedback': 'Feedback System',
