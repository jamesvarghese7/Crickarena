...
async function payEntryFee(){
  try{
    ...
    // Registration will be created/approved after successful payment verification.
    ...
    const options = {
      ...
      handler: async function (response){
        try{
          ...
          // Create tournament registration (pending) after payment success
...
const editForm = ref({ name: '', format: 'league', district: '', maxTeams: 16, startDate: '', endDate: '', registrationDeadline: '', entryFee: 0, description: '', rules: '', venuesText: '' });
function beginEdit(){
